...
// 专辑名数组
let albums = ['牧马城市', '水星记', '麒麟', '别烦恼', '彩虹', '我叫长安,你叫故里', '万疆', '桃花笑', '花,太阳,彩虹,你', '长街万象'];
// 歌曲信息数组
let track_names = ['毛不易 - 牧马城市', '郭顶 - 水星记', '早安 - 麒麟', '皮卡丘多多 - 别烦恼', 'TimeZ - 彩虹', '尹昔眠 - 我叫长安,你叫故里', '李玉刚 - 万疆', '尹昔眠 - 桃花笑', '法老 - 花,太阳,彩虹,你', '程响 - 长街万象'];
